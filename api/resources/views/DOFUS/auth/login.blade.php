        ...
        <div id="login-form">
            <div class="left">
                ...
                <div class="form-group">
                    ...
                    <input id="username" type="text" autocorrect="off" autocapitalize="off" placeholder="Email" name="email" value="{{ Input::old('username') }}" @if ($errors->has('auth')) class="has-error" @endif />
                </div>
                <div class="form-group">

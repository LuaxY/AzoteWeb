                ...
                <div class="panel panel-primary" style="margin-top:10px;">
                    ...
                    <div class="panel-body">
                        <center>
                            ...
                            <a href onClick="openModal(event, '{{ $payment->link }}/{{ $key }}?ticket={{ $ticket }}'); return false;" class="btn btn-default" target="_blank">Payer avec <img src="{{ URL::asset('images/' . $method . '.png') }}" height="30" /></a>

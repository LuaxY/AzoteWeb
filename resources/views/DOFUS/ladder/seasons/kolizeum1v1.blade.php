      ...
      <div class="col-sm-6 col-md-6">
         <div class="ak-section-kolizeum ak-block-hp-ladder">
            <div class="ak-section-title">
               <a href="{{URL::route('ladder.kolizeum1v1.season', [$server, $oldSeason->id])}}"><span class="ak-text">Saison {{$oldSeason->id}} <small style="float:right;"> {{$oldSeason->begin->format('d M Y')}} - {{$oldSeason->end->format('d M Y')}}</small></span></a>
            </div>
